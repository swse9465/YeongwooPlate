...
const JMTContentListCard2 = ({storeNO,storeName,address,storeScore,userNickname,userProfile,content,url,wish}) => (
    <div style={{marginBottom:"50px", width:"920px"}}>
    {/* celled */}
    <Grid >
        <Grid.Row>
...
export default JMTContentListCard2;
